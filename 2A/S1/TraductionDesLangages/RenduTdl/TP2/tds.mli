...
type info =
  ...
  (*INformation associé à une éthoqiette, il est plus facile de le gerer comme ça car on ajoute les infos des ethiquette dans une tds a part*)
  | InfoEthiq of string * string
(* Table des symboles *)
type tds 
