...
%La frequence mesurée est inférieur à F0 car les conditions de Shanon ne
%sont pas respecées (ie Fe > 2F0), donc, des l'échantillonage il y a un
%empietement, et donc la fréquence echantillonnée est plut petite que F0.
